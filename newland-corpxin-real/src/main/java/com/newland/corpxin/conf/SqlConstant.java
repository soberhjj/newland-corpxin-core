...
public interface SqlConstant {
	...
	String SQL_INSERT_UPDATE_BASICINFO = "insert into ads_company_basicinfo (id, ent_name, legal_person, open_status, " +
			...
			"values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) " +
			"ON DUPLICATE KEY update " +
			"id = values(id), ent_name = values(ent_name), legal_person = values(legal_person), open_status = values(open_status), " +
